...
public class IncomeService : IIncomeService
{
    ...
    public IncomeService(IIncomeRepository repository, IConfiguration configuration)
    {
    ...
    public async Task<decimal> CalculateCurrentIncome(string currency)
    {
        ...
        var convertedIncome = await CurrencyHelper.ConvertCurrency(income, "PLN", currency, _configuration);
